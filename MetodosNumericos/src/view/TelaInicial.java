	...
	public void telainicial() {
		...
		oka.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				metodos.gaussEliminacao(criaMatriz.matrizHilbert());
		...
		okb.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				metodos.gaussPivotamentoParcial(criaMatriz.matrizHilbert());
		...
		okc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				metodos.gaussPivotamentoParcialComEscala(criaMatriz.matrizHilbert());
		...
		btnNewButtond.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				metodos.gaussPivotamentoTotal(criaMatriz.matrizHilbert());
		...
		btnNewButtone.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				boolean convergiu = metodos.jacobi(criaMatriz.matrizHilbert(), Double.parseDouble(toleranciae.getText()), Integer.parseInt(iteracoese.getText()));
		...
		btnNewButtonf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				boolean convergiu = metodos.gaussSeidel(criaMatriz.matrizHilbert(), Double.parseDouble(toleranciaf.getText()), Integer.parseInt(iteracoesf.getText()));
		...
		btnNewButtong.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				boolean convergiu = metodos.sobreRelaxamento(criaMatriz.matrizHilbert(), Double.parseDouble(omegag.getText()), Double.parseDouble(toleranciag.getText()), Integer.parseInt(iteracoesg.getText()));
